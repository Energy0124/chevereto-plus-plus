...
function is_browser(e, t) {
    return e == BrowserDetect.browser ? "undefined" != typeof t ? t == BrowserDetect.version : !0 : !1
}
...
var BrowserDetect = {
    init: function () {
        this.browser = this.searchString(this.dataBrowser), this.version = this.searchVersion(navigator.userAgent) || this.searchVersion(navigator.appVersion), this.shortversion = this.browser + this.version, this.OS = this.searchString(this.dataOS)
    },
...
BrowserDetect.init(), document.documentElement.className += " " + BrowserDetect.browser + " " + BrowserDetect.shortversion + " " + BrowserDetect.OS;
for (var i = 0; i < BrowserDetect.dataBrowser.length; i++) eval("function is_" + BrowserDetect.dataBrowser[i].identity + '(version) { return is_browser("' + BrowserDetect.dataBrowser[i].identity + '", version); }');
for (var i = 0; i < BrowserDetect.dataOS.length; i++) eval("function is_" + BrowserDetect.dataOS[i].identity + '() { return "' + BrowserDetect.dataOS[i].identity + '" == "' + BrowserDetect.OS + '"; }');
(function (e, t) {
...
!function (e) {
    if ("function" == typeof define && define.amd) define(e); else if ("object" == typeof exports) module.exports = e(); else {
        var n = window.Cookies, o = window.Cookies = e(window.jQuery);
