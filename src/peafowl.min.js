$(function () {
    ...
    $(window).on("resize", function () {
        ...
        var device = PF.fn.getDeviceName(), handled = ["phone", "phablet"], desktop = ["tablet", "laptop", "desktop"];
        ...
        $(".antiscroll").removeClass("jsly").data("antiscroll", "");
        $(".antiscroll-inner").css({height: "", width: "", maxheight: ""});
    ...
    $(document).on("click", "[data-scrollto]", function (e) {
        var target = $(this).data("scrollto"), $target = $(!target.match(/^\#|\./) ? "#" + target : target);
        if ($target.exists()) {
            PF.fn.scroll($target);
        } else {
    ...
    $(document).on("click", "[data-trigger]", function (e) {
        var trigger = $(this).data("trigger"), $target = $(!trigger.match(/^\#|\./) ? "#" + trigger : trigger);
        if ($target.exists()) {
            e.stopPropagation();
            e.preventDefault();
    ...
    $(document).on("submit", "form[data-action=validate]", function (e) {
        var type = $(this).data("type"), errors = false, $validate = $(this).find("[required], [data-validate]");
        $validate.each(function () {
            var input_type = $(this).attr("type"), pattern = $(this).attr("pattern"), errorFn = function (el) {
                $(el).highlight();
                errors = true;
            };
    ...
    $(document).on("change", "select[data-combo]", function () {
        ...
        if ($combo_target.exists()) {
            $combo_target.show().find("[data-required]").each(function () {
    ...
    $(document).on("keyup change blur", ":input[type=password]", function () {
        var password = testPassword($(this).val()), $parent = $(this).closest("div");
        if ($(this).val() == "") {
            password.percent = 0;
            password.verdict = "";
        }
    ...
    $(document).on("submit", PF.obj.modal.selectors.root + " form", function (e) {
        if ($(this).data("prevented")) return false;
    ...
    $(document).on("click", "[data-modal=edit],[data-modal=form],[data-confirm]", function (e) {
        ...
        var args = $this.data("args"), submit_function = window[$target.data("submit-fn")],
            cancel_function = window[$target.data("cancel-fn")], onload_function = window[$target.data("load-fn")],
            submit_done_msg = $target.data("submit-done"), ajax = {
    ...
    $(document).on("keydown", PF.obj.modal.selectors.root + " input", function (e) {
        var $this = $(e.target), key = e.charCode || e.keyCode;
        if (key !== 13) {
            PF.fn.growl.close();
            return;
        }
        if (key == 13 && $("[data-action=submit]", PF.obj.modal.selectors.root).exists() && !$this.is(".prevent-submit")) {
    ...
    $(document).on("keyup change", "input.search", function (e) {
        var $input = $(this), $div = $(this).closest(".input-search");
        if (!$(this).closest("[data-action=top-bar-search-input]").exists()) {
    ...
    $(document).on("click mouseenter", ".pop-btn", function (e) {
        ...
        var $this_click = $(e.target), $pop_btn, $pop_box, devices = $.makeArray(["phone", "phablet"]);
        var $this = $(this);
        ...
        if (PF.fn.isDevice(devices)) {
            ...
            if ($pop_box.is(":visible")) {
                ...
                if ($this.closest(PF.fn.topMenu.vars.menu).exists()) {
                    ...
                    $(PF.fn.topMenu.vars.menu).css({height: $(window).height() + parseInt(menu_top),});
                }
                setTimeout(function () {
                    ...
                    callback($pop_box);
                    if ($this.closest(PF.fn.topMenu.vars.menu).exists()) {
                        $(PF.fn.topMenu.vars.menu).css({height: "",});
        ...
        var $pop_btn = $(this), $pop_box = $(".pop-box", $pop_btn);
    ...
    if (typeof State.data == "undefined") {
        History.replaceState({scrollTop: 0}, document.title, window.location.href);
    }
    ...
    $(document).on("click", "[data-action=tab-menu]", function () {
        var $tabs = $(this).closest(".header").find(".content-tabs"), visible = $tabs.is(":visible"), $this = $(this);
        if (!visible) {
    ...
    $(document).on("click", "[data-toggle]", function () {
        var $target = $("[data-content=" + $(this).data("toggle") + "]"), show = !$target.is(":visible");
...
PF.obj.config = {
    base_url: "",
    json_api: "/json/",
    listing: {items_per_page: 24},
    animation: {easingFn: "ease", normal: 400, fast: 250}
};
PF.obj.l10n = {};
...
String.prototype.getBytes = function () {
    var units = ["KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"], suffix = this.toUpperCase().substr(-2);
...
String.prototype.formatBytes = function (round) {
    var bytes = parseInt(this), units = ["KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"];
    if (!$.isNumeric(this)) {
        return false;
    }
    ...
    for (var i = 0; i < units.length; i++) {
        var multiplier = Math.pow(1000, i + 1), threshold = multiplier * 1000;
        if (bytes < threshold) {
...
PF.fn.deparam = function (querystring) {
    ...
    var obj = {}, pairs = querystring.replace(/^[\?|&]*/, "").replace(/[&|\?]*$/, "").split("&");
...
String.prototype.removeURLParameter = function (key) {
    var url = "", deparam = PF.fn.deparam(this);
...
String.prototype.truncate_middle = function (l) {
    var l = typeof(l) != "undefined" ? l : 40, chunk_l = (l / 2), url = this.replace(/https?:\/\//g, "");
    if (url.length <= l) {
        return url;
    }

    function shortString(s, l, reverse) {
        var stop_chars = [' ', '/', '&'], acceptable_shortness = l * 0.80,
            reverse = typeof(reverse) != "undefined" ? reverse : false,
            s = reverse ? s.split("").reverse().join("") : s, short_s = "";
        for (var i = 0; i < l - 1; i++) {
            short_s += s[i];
...
jQuery.extend({
    compare: function (a, b) {
        var obj_str = '[object Object]', arr_str = '[object Array]', a_type = Object.prototype.toString.apply(a),
...
jQuery.fn.bindFormData = function () {
    $(":input", this).each(function () {
        ...
        if ($(this).is("select")) {
            var index = this.selectedIndex, i = 0;
...
jQuery.Event.prototype.keydown_numeric = function () {
    ...
    var key = e.charCode || e.keyCode, target = e.target,
        value = ($(target).val() == "") ? 0 : parseInt($(target).val());
    if (key == 13) {
        return true;
    }
    if (key == 46 || key == 8 || key == 9 || key == 27 || (key == 65 && e.ctrlKey === true) || (key >= 35 && key <= 40)) {
        return true;
    } else {
...
PF.fn.bindtipTip = function ($target, options) {
    ...
    var bindtipTipoptions = {delay: 0, content: false, fadeIn: 0};
...
jQuery.fn.shake = function (callback) {
    this.each(function (init) {
        var jqNode = $(this), jqNode_position = jqNode.css("position");
        ...
        if (!jqNode.is(":animated")) {
            for (var x = 1; x <= 2; x++) {
                jqNode.animate({left: jqNode_left - 10}, 0).animate({left: jqNode_left}, 30).animate({left: jqNode_left + 10}, 30).animate({left: jqNode_left}, 30);
            }
            ;
...
jQuery.fn.highlight = function (color) {
    ...
    ;var base_background_color = $(this).css("background-color"), base_background = $(this).css("background");
    $(this).css({
        background: "",
...
jQuery.fn.pf_slideDown = function (speed, callback) {
    var default_speed = "normal", this_length = $(this).length, css_prechanges, css_animation, animation_speed;
    ...
    $(this).each(function (index) {
        var this_css_top = parseInt($(this).css("top")), to_top = this_css_top > 0 ? this_css_top : 0;
        if (speed == 0) {
            css_prechanges = {
                display: "block",
                opacity: 0
            }, css_animation = {opacity: 1}, animation_speed = jQuery.speed("fast").duration;
        } else {
...
jQuery.fn.pf_slideUp = function (speed, callback) {
    var default_speed = "normal", this_length = $(this).length;
    if (typeof speed == "function") {
        callback = speed;
        speed = default_speed;
    }
...
PF.fn.growl = {
    selectors: {root: "#growl"}, str: {timeout: null, timeoutcall: false}, call: function (options) {
        ...
        var offsetX = {modal: $(PF.obj.modal.selectors.box).offset().left, growl: $growl.offset().left},
...
PF.fn.modal = {
    str: {transition: "all " + PF.obj.config.animation.fast + "ms ease"}, call: function (options) {
        ...
        var modal_base_template = ['<div id="', PF.obj.modal.selectors.root.replace("#", ""), '"class="fullscreen ' + overlay_background + '"><div id="', PF.obj.modal.selectors.box.replace("#", ""), '"class="clickable"><div id="', PF.obj.modal.selectors.body.replace("#", ""), '">%MODAL_BODY%</div>%MODAL_BUTTONS%<span class="close-modal icon-close" data-action="close-modal"></span></div></div>'].join("");
                ...
                if ($this.is(PF.obj.modal.selectors.submit_button)) {
                    ...
                    if (modal_submit_continue) {
                        if (modal_options.ajax.url) {
                            ...
                            PF.fn.loading.inline($(PF.obj.modal.selectors.btn_container + ".loading", PF.obj.modal.selectors.root), {
                                size: "small",
                                message: modal_loading_msg,
                                valign: "center"
                            });
    ...
    stock_load: function () {
        ...
        $(PF.obj.listing.selectors.content_listing + "[data-load=ajax]").each(function () {
            ...
            var dataParams = PF.fn.deparam($(this).data("params")),
                dataParamsHidden = PF.fn.deparam($(this).data("params-hidden")), params = {
...
PF.fn.listing.ajax = function () {
    ...
    PF.obj.listing.XHR = $.ajax({
        ...
        if (XHR.readyState == 4 && typeof response !== "undefined") {
            ...
            $content_listing.data({"load": "", "page": PF.obj.listing.query_string.page});
...
PF.fn.listing.columnizer = function (forced, animation_time, hard_forced) {
    var device_to_columns = {phone: 1, phablet: 3, tablet: 4, laptop: 5, desktop: 6, largescreen: 7,};
    if (typeof forced !== "boolean") var forced = false;
    if (typeof PF.obj.listing.mode == "undefined") forced = true;
    if (typeof hard_forced !== "boolean") {
        var hard_forced = false, default_hard_forced = true;
    } else {
    ...
    var $container = $("#content-listing-tabs").exists() ? $(PF.obj.listing.selectors.content_listing_visible, "#content-listing-tabs") : $(PF.obj.listing.selectors.content_listing),
        $pad_content_listing = $(PF.obj.listing.selectors.pad_content, $container), list_mode = "responsive",
    ...
    $list_item.each(function (index) {
        $(this).addClass("jsly");
        var $list_item_img = $(".list-item-image", this), $list_item_src = $(".list-item-image img", this),
            $list_item_thumbs = $(".list-item-thumbs", this), isJslyLoaded = $list_item_src.hasClass("jsly-loaded");
        $list_item_src.show();
        if (hard_forced) {
        ...
        var image = {w: parseInt($list_item_src.attr("width")), h: parseInt($list_item_src.attr("height"))};
        ...
        if (hard_forced && PF.obj.listing.columns_number > 1) {
            ...
            if (image.w > $container.width()) {
                $(".image-container:not(.list-item-avatar-cover)", this).css(image.ratio < 1 ? {
                    maxWidth: "100%",
                    height: "auto"
                } : {height: "100%", width: "auto"});
                $list_item_src.css(image.ratio < 1 ? {maxWidth: "100%", height: "auto"} : {
                    height: "100%",
                    width: "auto"
                });
            }
        ...
        if (empty || ($list_item_img.css("min-height") && !$list_item_src.hasClass("jsly"))) {
            var list_item_img_min_height = parseInt($list_item_img.css("height")),
                col = {w: $(this).width(), h: isFixed ? $(this).width() : null},
            ...
            if ($list_item_src.height() !== 0 && ($list_item_img.height() > $list_item_src.height() || isFixed)) {
                $list_item_src.parent().css({"marginTop": ($list_item_img.outerHeight() - $list_item_src.height()) / 2});
            }
            if ($list_item_img.width() < $list_item_src.width()) {
                $list_item_src.parent().css({"marginLeft": -(($list_item_src.outerWidth() - $list_item_img.width()) / 2) + "px"});
            }
            ...
            if (PF.obj.listing.columns_number > 6 && (list_item_src_pitfall_x > 0 || list_item_src_pitfall_y > 0)) {
                var pitfall_ratio_x = list_item_src_pitfall_x / $list_item_img.width(),
                    pitfall_ratio_y = list_item_src_pitfall_y / $list_item_img.height(), pitfall = {};
...
PF.fn.loading = {
    spin: {
        small: {lines: 11, length: 0, width: 3, radius: 7, speed: 1, trail: 45, blocksize: 20},
        normal: {lines: 11, length: 0, width: 5, radius: 10, speed: 1, trail: 45, blocksize: 30},
        big: {lines: 11, length: 0, width: 7, radius: 13, speed: 1, trail: 45, blocksize: 40},
        huge: {lines: 11, length: 0, width: 9, radius: 16, speed: 1, trail: 45, blocksize: 50}
        ...
        var $loader_fs = $("#pf-fullscreen-loader"), $loader_os = $("#pf-onscreen-loader");
...
PF.obj.follow_scroll.process = function (forced) {
    ...
    if (!PF.obj.follow_scroll.$node.exists()) return;
...
PF.fn.topMenu = {
    vars: {
        ...
        $("#top-bar").css("position", "fixed").append($("<div/>", {
            id: "menu-fullscreen",
            "class": "touch-scroll",
            html: $('<ul/>', {html: $(".top-bar-left").html() + $(".top-bar-right").html()})
        }).css({borderTopWidth: this.vars.menu_top, left: "-100%",}));
...
(function ($) {
    $.fn.tipTip = function (options) {
        ...
        return this.each(function () {
            var org_elem = $(this), data = org_elem.data("tipTip"),
            ...
            function active_tiptip() {
                ...
                var top = parseInt(org_elem.offset()["top"]), left = parseInt(org_elem.offset()["left"]),
                    org_width = parseInt(org_elem.outerWidth()), org_height = parseInt(org_elem.outerHeight()),
                    tip_w = tiptip_holder.outerWidth(), tip_h = tiptip_holder.outerHeight(),
                    w_compare = Math.round((org_width - tip_w) / 2), h_compare = Math.round((org_height - tip_h) / 2),
                    marg_left = Math.round(left + w_compare), marg_top = Math.round(top + org_height + opts.edgeOffset),
                    t_class = "", arrow_top = "", arrow_left = Math.round(tip_w - 12) / 2;
...
!function (e) {
    ...
    t.isInstanceOf = function (e, t) {
        ...
        var n, s, l, d, u, c, f, g, h, m, p, S = document.createElement("canvas"),
            b = e.getContext || t.hasCanvasOption(i) && S.getContext, x = e.naturalWidth || e.width,
            y = e.naturalHeight || e.height, v = x, P = y;
        S.originalWidth = x;
        S.originalHeight = y;
        if (b && (i = t.getTransformedOptions(e, i, a), f = i.left || 0, g = i.top || 0, i.sourceWidth ? (u = i.sourceWidth, void 0 !== i.right && void 0 === i.left && (f = x - u - i.right)) : u = x - f - (i.right || 0), i.sourceHeight ? (c = i.sourceHeight, void 0 !== i.bottom && void 0 === i.top && (g = y - c - i.bottom)) : c = y - g - (i.bottom || 0), v = u, P = c), n = i.maxWidth, s = i.maxHeight, l = i.minWidth, d = i.minHeight, b && n && s && i.crop ? (v = n, P = s, p = u / c - n / s, p < 0 ? (c = s * u / n, void 0 === i.top && void 0 === i.bottom && (g = (y - c) / 2)) : p > 0 && (u = n * c / s, void 0 === i.left && void 0 === i.right && (f = (x - u) / 2))) : ((i.contain || i.cover) && (l = n = n || l, d = s = s || d), i.cover ? (r(), o()) : (o(), r())), b) {
            if (h = i.pixelRatio, h > 1 && (S.style.width = v + "px", S.style.height = P + "px", v *= h, P *= h, S.getContext("2d").scale(h, h)), m = i.downsamplingRatio, m > 0 && m < 1 && v < u && P < c) for (; u * m > v;) S.width = u * m, S.height = c * m, t.renderImageToCanvas(S, e, f, g, u, c, 0, 0, S.width, S.height), u = S.width, c = S.height, e = document.createElement("canvas"), e.width = u, e.height = c, t.renderImageToCanvas(e, S, 0, 0, u, c, 0, 0, u, c);
    ...
    }, e.metaDataParsers = {jpeg: {65505: []}}, e.parseMetaData = function (t, i, a, o) {
        a = a || {}, o = o || {};
        var r = this, n = a.maxMetaDataSize || 262144,
        ...
        !s && e.readFile(e.blobSlice.call(t, 0, n), function (t) {
            ...
            if (65496 === c.getUint16(0)) {
                for (; f < g && (n = c.getUint16(f), n >= 65504 && n <= 65519 || 65534 === n);) {
                    ...
                    if (l = e.metaDataParsers.jpeg[n]) for (d = 0; d < l.length; d += 1) l[d].call(r, c, f, s, o, a);
                    f += s, h = f
                }
    ...
    merge(Spinner.prototype, {
        spin: function (target) {
            ...
            for (; i < o.lines; i++) {
                ...
                if (o.shadow) {
                    ins(seg, css(fill("rgba(0,0,0,.25)", "0 0 4px rgba(0,0,0,.5)"), {top: 2 + "px"}))
                }
...
(function ($) {
    $.fn.antiscroll = function (options) {
        return this.each(function () {
            if ($(this).data("antiscroll")) $(this).data("antiscroll").destroy();
    ...
    Antiscroll.prototype.refresh = function () {
        ...
        if (this.x) if (!this.horizontal && needHScroll) this.horizontal = new Scrollbar.Horizontal(this); else if (this.horizontal && !needHScroll) {
            this.horizontal.destroy();
            this.horizontal = null
        } else if (this.horizontal) this.horizontal.update();
        if (this.y) if (!this.vertical && needVScroll) this.vertical = new Scrollbar.Vertical(this); else if (this.vertical && !needVScroll) {
    ...
    function Scrollbar(pane) {
        ...
        if (initialDisplay !== false) {
            this.show();
            if (this.pane.autoHide) this.hiding = setTimeout($.proxy(this, "hide"), parseInt(initialDisplay, 10) || 3E3)
        }
    }
    ...
    Scrollbar.prototype.scroll = function () {
        if (!this.shown) {
            this.show();
            if (!this.enter && !this.dragging) if (this.pane.autoHide) this.hiding = setTimeout($.proxy(this, "hide"), 1500)
        }
        this.update()
    };
    Scrollbar.prototype.mousedown = function (ev) {
        ...
        var pane = this.pane, move = $.proxy(this, "mousemove"), self = this;
        $(this.el[0].ownerDocument).mousemove(move).mouseup(function () {
            self.dragging = false;
    ...
    Scrollbar.Horizontal.prototype.update = function () {
        var paneWidth = this.pane.el.width(), trackWidth = paneWidth - this.pane.padding * 2,
            innerEl = this.pane.inner.get(0);
        this.el.css("width", trackWidth * paneWidth / innerEl.scrollWidth).css("left", trackWidth * innerEl.scrollLeft / innerEl.scrollWidth);
        return paneWidth < innerEl.scrollWidth
    };
    Scrollbar.Horizontal.prototype.mousemove = function (ev) {
        var trackWidth = this.pane.el.width() - this.pane.padding * 2, pos = ev.pageX - this.startPageX,
            barWidth = this.el.width(), innerEl = this.pane.inner.get(0);
        var y = Math.min(Math.max(pos, 0), trackWidth - barWidth);
        innerEl.scrollLeft = (innerEl.scrollWidth - this.pane.el.width()) * y / (trackWidth -
            barWidth)
    };
    ...
    Scrollbar.Vertical.prototype.update = function () {
        var paneHeight = this.pane.el.height(), trackHeight = paneHeight - this.pane.padding * 2,
    ...
    Scrollbar.Vertical.prototype.mousemove = function (ev) {
        var paneHeight = this.pane.el.height(), trackHeight = paneHeight - this.pane.padding * 2,
            pos = ev.pageY - this.startPageY, barHeight = this.el.height(), innerEl = this.innerEl;
        var y = Math.min(Math.max(pos, 0), trackHeight - barHeight);
        innerEl.scrollTop = (innerEl.scrollHeight - paneHeight) * y / (trackHeight - barHeight)
    };
    Scrollbar.Vertical.prototype.mousewheel = function (ev, delta, x, y) {
        if (y > 0 && 0 == this.innerEl.scrollTop || y < 0 && this.innerEl.scrollTop + Math.ceil(this.pane.el.height()) == this.innerEl.scrollHeight) {
            ev.preventDefault();
            return false
        }
    };
...
!function (t) {
    ...
    return function t(e, n, r) {
        ...
        1: [function (t, e, n) {
            ...
            n.__esModule = !0;
            var s = t("./clipboard-action"), c = r(s), u = t("tiny-emitter"), l = r(u), f = t("good-listener"),
                d = r(f), h = function (t) {
                    function e(n, r) {
